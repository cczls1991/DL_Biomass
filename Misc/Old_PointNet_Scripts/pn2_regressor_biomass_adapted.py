...
class Net(torch.nn.Module):
    def __init__(self, num_features):
        ...
        self.sa1_module = SAModule(0.2, 2, MLP([3 + num_features, 64, 64, 128], act='LeakyReLU')) #Use ELU instead of default ReLU because this is what Oehmcke uses
        ...
        self.mlp = MLP([1024, 128, 128, 1], act='LeakyReLU', dropout=0.5,
                       batch_norm=False)
